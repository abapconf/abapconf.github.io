sap.ui.define([
	...
	function (BaseController, models, mobileLibrary) {
		...
		return BaseController.extend("abapconf.2023.org.controller.footer.Footer", {
			onInit: function () {
			...
			handleEmailPress: function (oEvent) {
				URLHelper.triggerEmail("abapconf@gmail.com", "Information about ABAPConf 2023", false, false, false, true);
            },
