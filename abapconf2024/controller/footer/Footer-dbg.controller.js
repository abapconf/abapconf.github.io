sap.ui.define([
	...
	function (BaseController, models, mobileLibrary) {
		...
		return BaseController.extend("abapconf.2024.org.controller.footer.Footer", {
			onInit: function () {
			...
			handleEmailPress: function (oEvent) {
				URLHelper.triggerEmail("abapconf@gmail.com", "Information about ABAPConf 2024", false, false, false, true);
            },
            ...
            pressEventbrite: function (oEvent) {
                window.open( "https://www.eventbrite.com/e/abapconf-2024-registration-669212682147","_blank");
            },
